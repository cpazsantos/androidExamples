		...
		mApplicationContext.sendOrderedBroadcast(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						// TO DO: Check whether the result code is RESULT_OK

						if (getResultCode() != Activity.RESULT_OK) {

							// TO DO:  If so, create a PendingIntent using the
							...
							// TO DO: Set the notification View's text to
                            ...
                            // TO DO: Use the Notification.Builder class to
                            ...
                            Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext)
                                    .setAutoCancel(true)
                                    .setTicker("Download status")
                                    .setSmallIcon(android.R.drawable.stat_sys_warning)
                                    .setContentIntent(pendingIntent)
                                    .setContent(mContentView);

                            // TO DO: Send the notification
